            ...
            <section className='hotel_head'>
                    ...
                    <div className='makeflex'>
                        <div className='makeflex'>
                            <div className=''>
                                ...
                                <input type='text' value={value} onMouseEnter={handleMouse1} className='input_color' onChange={selectcity} placeholder='Haridwar' />
                ...
                <div className='home_bar goa_prop_container'>
                    <p className='font12 font12_text_white'><Link to="/">Home
                        <span><MdOutlineKeyboardArrowRight /></span></Link><span className='font12 text_white'>Hotels and more in Haridwar</span></p>
                    <h2 className='heading_2'>{goapropertydata.length} Properties in Haridwar</h2>
                </div>
            ...
            <section>
                <div className='goa_prop_container py-4 d-flex'>
                    ...
                    <div className='hotel_listing'>
                        <p className='latobold font28 showing'>Showing Properties in Haridwar</p>
...
export default Haridwar_Property
